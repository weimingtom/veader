...
public class DataHelper {
   ...
   private static final String INSERT = "insert into " + TABLE_NAME + "(path, description, name) values (?, ?, ?)";
   ...
   public SQLiteDatabase getDb() {
	...
	public long insertLibrary(String path, String description, String name) {
