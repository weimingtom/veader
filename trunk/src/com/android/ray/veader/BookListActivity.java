...
import com.android.ray.veader.util.SDCardUtil;
import com.android.ray.veader.util.SyncAgent;
...
//            return dialog;
            ...
            View cataView = getLayoutInflater().inflate(R.layout.veader, null);
            final TextView _messageView = (TextView)cataView.findViewById(R.id.message);
            _messageView.setTextSize(14);
